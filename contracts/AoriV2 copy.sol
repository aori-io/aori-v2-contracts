...
//     // @notice Mapping of settled and cancelled orders
...
//         require(
//             !hasCancelled(matching.makerOrder.offerer, makerHash),
//             "Maker order has been cancelled"
//         );
//         require(
//             !hasCancelled(matching.takerOrder.offerer, takerHash),
//             "Taker order has been cancelled"
//         );
...
//         require(msg.sender == order.offerer, "Only offerer can cancel");

//         bytes32 orderHash = getOrderHash(order);
//         require(
//             !cancelledOrders[order.offerer][orderHash],
//             "Order has already been cancelled"
//         );
//         cancelledOrders[order.offerer][orderHash] = true;

//         emit Cancelled(orderHash, order.zone, order.offerer, order);
//     }
